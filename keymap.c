...
[_WINBASE] = LAYOUT_preonic_1x2uC(  /* Base Layer */
 /*
  ...
  KC_LGUI,MIRR_TAB,NUMPAD, KC_BSPC, CTLDEL,KC_TAB, FN_ESC,  	SFT_ENT,KC_SPC,  ARROWS,     KC_EQUAL,	CPYPST,\
...
[_MIRROR] = LAYOUT_preonic_1x2uC(  /*MIRROR*/
  ...
  KC_EQUAL,KC_MINUS,	_______,  KC_SPC,  KC_ENT, FN_ESC,KC_TAB,	    CTLDEL,KC_BSPC,	TO(_WINBASE),_______, _______, \
  _______, _______,         _______, _______, _______,          _______, _______, _______,       _______, _______, _______ \
  ),
/*BATREUS:
...
[_ARROWS] = LAYOUT_preonic_1x2uC(  /* RAISE - Arrows */
  ...
  TO(_WINBASE),	KC_APP,		_______,   	_______,   	_______,	_______, _______,  _______, _______, _______,  _______, _______, \
  _______, 	_______,   	_______,   	_______,   	_______,	_______, _______,  _______, _______, _______, _______\
/*
BATreus
...
/*  KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_QUES, KC_DQT,  KC_DEL,  \
  ...
  _______, KC_APP,  _______, _______, _______,  _______,	_______,_______,KC_KP_DOT,TO(_WINBASE), _______, _______, \
  _______, _______, _______, _______, _______,  _______, 	_______,_______,_______,_______, _______\
/*
BATreus
  _______, _______, FUNCTN, _______, _______, _______, _______,  _______, _______, FUNCTN,  _______, _______, \
